...
class magprofile_com:
	"""
	Magnetic field profiler.  Returns functions fBfld and fBderiv, used in
	StarMod.maghydrostar to determine and propagate magnetic field.  THIS IS THE
	OLDER FILE THAT HAS MORE OPTIONS, BUT NOT NEARLY AS REFINED AS magprofile_mass.py
	IN ACCURATELY REPRODUCING MAGNETIC FIELD
